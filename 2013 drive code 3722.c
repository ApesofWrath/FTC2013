...
#pragma config(Motor,  mtr_S1_C3_1,     liftMotor1,    tmotorTetrix, openLoop, encoder)
...
void initializeRobot()
{
  ...
  // Sensors are automatically configured and setup by ROBOTC. They may need a brief time to stabilize.
        //motors are stopped when the robot is turned on
        motor[rightBack] = 0;
        motor[rightFront] = 0;
        motor[leftBack] = 0;
        motor[leftFront] = 0;
...
void drive()
{
        ...
        //switch between arcade and tank mode
        if (ARCADE)
        {
                tank = false;
        }
